...
const PrivateParty = ({ open, onClose, scroll }) => {
  ...
  const pdfFile = "/assets/Other/PWYC Private Party Application.pdf"; // PDF file path
  ...
  return (
    ...
    >
      <CenteredDialogTitle id="scroll-dialog-title">Private Party Form</CenteredDialogTitle>
