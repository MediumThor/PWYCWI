...
export interface AirV1Interface extends utils.Interface {
  contractName: "AirV1";
  functions: {
    ...
    "waterLevelingRate(uint256)": FunctionFragment;
    "withdrawAllBonsaiAndClaim(uint256[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "levelUpBonsai",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "myStakedBonsai",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "waterLevelingRate",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "withdrawAllBonsaiAndClaim",
    values: [BigNumberish[]]
  ): string;
...
export type BurnedEvent = TypedEvent<
  [string, BigNumber],
  { owner: string; airsAmt: BigNumber }
>;
...
export interface AirV1 extends BaseContract {
  contractName: "AirV1";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AirV1Interface;
  ...
  functions: {
    ...
    myStakedBonsai(overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  callStatic: {
    ...
    levelUpBonsai(tid: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "Burned(address,uint256)"(owner?: null, airsAmt?: null): BurnedEventFilter;
    Burned(owner?: null, airsAmt?: null): BurnedEventFilter;

    "Minted(address,uint256)"(owner?: null, airsAmt?: null): MintedEventFilter;
    Minted(owner?: null, airsAmt?: null): MintedEventFilter;
  ...
  populateTransaction: {
    ...
    myStakedBonsai(overrides?: CallOverrides): Promise<PopulatedTransaction>;
